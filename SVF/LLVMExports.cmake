...
set_target_properties(LLVMSupport PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "rt;dl;-lpthread;m;ZLIB::ZLIB;/lib64/libtinfo.so;LLVMDemangle"
)
...
# Create imported target mlir-linalg-ods-gen
add_executable(mlir-linalg-ods-gen IMPORTED)
...
# Create imported target mlir_test_cblas
add_library(mlir_test_cblas SHARED IMPORTED)

# Create imported target mlir_test_cblas_interface
add_library(mlir_test_cblas_interface SHARED IMPORTED)
