...
#define DRCCTLIB_PRINTF(_FORMAT, _ARGS...) \
    DRCCTLIB_PRINTF_TEMPLATE("base_overhead", _FORMAT, ##_ARGS)
#define DRCCTLIB_EXIT_PROCESS(_FORMAT, _ARGS...) \
    DRCCTLIB_CLIENT_EXIT_PROCESS_TEMPLATE("base_overhead", _FORMAT, ##_ARGS)
...
ClientInit(int argc, const char *argv[])
{
    ...
    DRCCTLIB_INIT_LOG_FILE_NAME(name, "base_overhead", "out");
...
{
    dr_set_client_name("DynamoRIO Client 'base_overhead'",
