 ...
 * drcctlib_callret_overhead_test.cpp
 *
...
CallBackOnCall(int32_t slot, app_pc instr_addr, app_pc target_addr)
{
    ...
    inner_context_t* ctxt = drcctlib_get_full_cct(ctxt_hndl);
...
{
    dr_set_client_name("DynamoRIO Client 'drcctlib_callret_overhead_test'",
