...
//void dynamorio_annotate_redundant_barrier(unsigned long barrier_id, unsigned int * redundant)
//{
//    dr_fprintf(STDOUT, "called annotation!!\n");
//    *redundant = 1;
//}
...
{
    dr_fprintf(STDOUT, "Starting client barrier_profile %d\n", my_id);
    ...
    //        "dynamorio_annotate_redundant_barrier",
    //        (void*)dynamorio_annotate_redundant_barrier, false, 2, DR_ANNOTATION_CALL_TYPE_FASTCALL);
...
{
    my_id = id;
    dr_set_client_name("DynamoRIO Client 'barrier_profile'",
