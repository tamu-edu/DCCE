...
DCCELIB_PATH=$SRC_PATH/dccelib
DCCELIB_CLIENTS_ROOT_PATH=$SRC_PATH/dcce_clients
DCCELIB_CLIENTS_NAME_LIST=$(ls $DCCELIB_CLIENTS_ROOT_PATH)
...
rm -rf $DYNAMORIO_EXT_PATH/dccelib
ln -s $DRCCTLIB_PATH $DYNAMORIO_EXT_PATH/drcctlib
ln -s $DCCELIB_PATH $DYNAMORIO_EXT_PATH/dccelib
...
for CLIENT in $DCCELIB_CLIENTS_NAME_LIST
do
    rm -rf $DYNAMORIO_CLIENT_PATH/$CLIENT
    ln -s $DCCELIB_CLIENTS_ROOT_PATH/$CLIENT $DYNAMORIO_CLIENT_PATH/$CLIENT
done
